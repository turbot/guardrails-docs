...
| [Global Event Handler](guides/configuring-guardrails/global-event-handler) | Setup Global Event Handlers using Guardrails managed IAM roles or by custom IAM roles
