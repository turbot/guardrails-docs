...
![Discovery Level Settings showing organization tree with dropdown selectors for each OU and account](/images/docs/guardrails/guides/aws/migrate-exclude-to-discovery-level/discovery-level-settings.png)
