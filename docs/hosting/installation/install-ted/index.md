...
![Product Selection](./service-catalog-launch-product-ted.png)

## Step 4: Name Provisioned Product

Select a Name for the provisioned project. Typically, this will be "ted".

![Name Provisioned Product](./service-catalog-name-provisioned-product.png)
...
![Hive Configuration](./service-catalog-ted-parameter-hive-configuration.png)
...
![Database Configuration](./service-catalog-ted-parameter-database-configuration.png)
...
![Database Advanced High Availability](./service-catalog-ted-parameter-database-advanced-high-availability.png)
...
![Database Advanced Engine](./service-catalog-ted-parameter-database-advanced-engine.png)
...
![Database Advanced Storage](./service-catalog-ted-parameter-database-advanced-storage.png)
...
![Database Advanced Encryption](./service-catalog-ted-parameter-database-advanced-encryption.png)
...
![Database Advanced Authentication](./service-catalog-ted-parameter-database-advanced-authentication.png)
...
![Database Advanced Backups and Snapshots](./service-catalog-ted-parameter-database-advanced-backup-snapshot.png)
...
![Database Advanced Logging](./service-catalog-ted-parameter-database-advanced-logging.png)
...
![Cache](./service-catalog-ted-parameter-cache.png)
...
![Foundation Parameters](./service-catalog-ted-parameter-adavanced-foundation-parameters.png)
...
![Advanced Infrastructure](./service-catalog-ted-parameter-advanced-infrastructure.png)

## Step 18: Launch Product

Select **Launch product**.

![Launch Product](./service-catalog-ted-launch-product-action.png)
