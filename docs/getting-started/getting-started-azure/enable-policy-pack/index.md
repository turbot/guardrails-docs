...
<p><img alt="tls setting" src="/home/jon/guardrails-docs/docs/getting-started/getting-started-azure/enable-policy-pack/tls-setting.png"/></p>
...
<p><img alt="filter 1" src="/home/jon/guardrails-docs/docs/getting-started/getting-started-azure/enable-policy-pack/filter-1.png"/></p>
...
<p><img alt="filter 2" src="/home/jon/guardrails-docs/docs/getting-started/getting-started-azure/enable-policy-pack/filter-2.png"/></p>
...
<p><img alt="locate-policy-pack" src="/home/jon/guardrails-docs/docs/getting-started/getting-started-azure/enable-policy-pack/filter-3.png"/></p>

Click on the **Accounts** sub-tab from the homepage and then select your Azure subscription.

<p><img alt="locate-policy-pack-manage-2" src="/home/jon/guardrails-docs/docs/getting-started/getting-started-azure/enable-policy-pack/locate-policy-pack-manage-2.png"/></p>

On the subscription resource page, select the **Detail** sub-tab.

<p><img alt="locate-policy-pack-manage-3" src="/home/jon/guardrails-docs/docs/getting-started/getting-started-azure/enable-policy-pack/locate-policy-pack-manage-3.png"/></p>
...
<p><img alt="locate-policy-pack-manage-4" src="/home/jon/guardrails-docs/docs/getting-started/getting-started-azure/enable-policy-pack/locate-policy-pack-manage-4.png"/></p>
...
<p><img alt="attach-1" src="/home/jon/guardrails-docs/docs/getting-started/getting-started-azure/enable-policy-pack/attach-1.png"/></p>
...
<p><img alt="attach-2" src="/home/jon/guardrails-docs/docs/getting-started/getting-started-azure/enable-policy-pack/attach-2.png"/></p>
...
<p><img alt="storage-account-in-alarm" src="/home/jon/guardrails-docs/docs/getting-started/getting-started-azure/enable-policy-pack/raw-storage-account-in-alarm.png"/></p>
