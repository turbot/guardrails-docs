---
title: 'TurbotControlTypeMetadata'
template: Documentation
sidebar_label: TurbotControlTypeMetadata
deprecated: false
nav:
  title: 'TurbotControlTypeMetadata'
  order: 10
...
<div style={{'fontFamily':'monospace'}}><span style={{'fontSize':'1.5rem','fontWeight':500}}>TurbotControlTypeMetadata</span></div>
